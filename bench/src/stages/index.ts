...
import { run as buildRuntime } from './build-runtime.js';
import { run as buildAspNetCore } from './build-aspnetcore.js';
...
registerStage(Stage.BuildRuntime, buildRuntime);
registerStage(Stage.BuildAspNetCore, buildAspNetCore);
