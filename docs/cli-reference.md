...
| Flag | Valid values |
|------|-------------|
| `--app <list>` | empty-browser, empty-blazor, blazing-pizza, havit-bootstrap, mud-blazor, micro-benchmarks, uno-gallery, igniteui-light, blazor-perf, semi-avalonia, avalonia-bench |
